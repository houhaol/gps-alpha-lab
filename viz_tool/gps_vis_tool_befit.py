...
# parser.add_argument("video_path", help="Neon Scene Video file path")
...
def open_and_populate_data():
    ...
    try:
        ...
        world_data = np.load(neon_folder_path + "/world_timestamps_unix.npy")
        world_df = pd.DataFrame(
            {
                "timestamp [ns]": world_data[:],
            }
        )
    ...
    # drop na values in latitude and longitude columns
...
try:
    ...
    neon_scene_path = neon_folder_path + "/world.mp4"
# neon_scene_path = "/mnt/d/BEFIT/ProcessedData/Study/BF002/2025-06-30-09-22-16/neon_player/world.mp4"
print(neon_scene_path)
app_event_options = []
if reverse_geocode:
    app_event_options = [
